...
public class SettingsDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        settingsVC = new SettingsViewController(this.context, inflater, v, (SettingsViewControllerDelegate) (((MainActivity) delegate).getViewController()));
    ...
    public void onStart() {
        ...
        BrainyCopterApplication.sharedApplicaion().setAppStage(AppStage.SETTINGS);
    ...
    public void onStop() {
        ...
        BrainyCopterApplication.sharedApplicaion().setAppStage(AppStage.HUD);
